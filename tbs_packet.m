function [tbs, nPRB]=tbs_packet(data,indMCS,MCS_table,v,link,SCS,BW,CP,PDCCH_config,PUCCH_config,N_OS)
...
% tengo que diferenciar entre DL y UL??
...
while tbs<data
    nPRB=nPRB+1;
    tbs=TBS_calculation(R(indMCS),Qm(indMCS),v,nPRB,link,SCS,BW,CP,PDCCH_config,PUCCH_config,N_OS);
end
