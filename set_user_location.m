...
switch esc
    case 1
        BS_x=2*(3.7*lanesxdir+1); %ancho de carril=3.7m (en EEUU), 1m separación entre direcciones y hasta la BS
        BS_y=Rcell;
        nUE=0;
    ...
    case 2
        BS_x=253; %ancho de carril=3.7m (en EEUU), 1m separación entre direcciones y hasta la BS
        BS_y=436;
        nUE=0;
        nUEinLane=floor(vehperlaneandkm/1000*Rcell*2);
        %vertical lanes
