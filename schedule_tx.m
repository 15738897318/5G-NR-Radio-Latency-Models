...
%     end 
    ...
    if flag==1
        ...
        tend=current_time_frame(m(h))+N_OS*Tslot; %tend es igual al tiempo en que comienza el siguiente símbolo o slot según el caso
        perror=rand();
        if perror<=BLER %el paquete llega correctamente
            fretx=1;
        end
        break;
    end
